...
```
├── final_project.js    # Electron main process + app logic (search, details, watchlist)
├── first_screen.html   # Home / search screen
├── second_screen.html  # Anime or manga detail view
├── third_screen.html   # Watchlist management
├── view_details.html   # (unused placeholder)
├── fyp.css             # Application styles
├── package.json
└── README.md
```
